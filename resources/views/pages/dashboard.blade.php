...
<main class="h-full overflow-y-auto">
    <div class="container px-6 mx-auto grid">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
            <!-- Card -->
            <div class="flex items-center p-4 rounded-lg shadow-xs bg-gray-800 text-white">
                <div class="p-3 mr-4 text-orange-500 bg-white rounded-full dark:text-orange-100 dark:bg-orange-500">
                ...
                <div>
                    <p class="mb-2 text-md font-base text-grey-300">
                        Total clients
                    </p>
            ...
            <div class="flex items-center p-4 bg-gray-800 rounded-lg shadow-xs">
                ...
                <div>
                    <p class="mb-2 text-md font-medium text-gray-100 dark:text-gray-400">
                        Account balance
                    </p>
            ...
            <div class="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                <div class="p-3 mr-4 text-blue-500 bg-white rounded-full dark:text-blue-100">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div>
                    <p class="mb-2 text-md font-medium text-gray-100">
                        New sales
                    </p>
            ...
            <!-- Card -->
            <div class="flex items-center p-4 rounded-lg shadow-xs bg-gray-800">
                <div class="p-3 mr-4 bg-white text-teal-300 rounded-full dark:text-teal-100">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
